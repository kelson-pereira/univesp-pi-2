"""
Configurações do Django para o projeto univesp_pi_2.

Gerado por 'django-admin startproject' usando Django 5.1.1.
...
ROOT_URLCONF = 'univesp_pi_2.urls'
...
WSGI_APPLICATION = 'univesp_pi_2.wsgi.application'
