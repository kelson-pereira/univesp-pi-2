...
class ValidarNumero(forms.Form):
    numero = forms.CharField(initial='', widget=forms.TextInput(attrs={'class':'form-control fs-2 mt-3','type':'number','inputmode':'numeric'}), label='Forneça o número do endereço do local do foco suspeito.', validators=[RegexValidator('^[0-9]{0,6}$', message='Número inválido, use somente números.')])
